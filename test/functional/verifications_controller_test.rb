...
class VerificationsControllerTest < ActionController::TestCase
  ...
  test "should create verification" do
    assert_difference('Verification.count') do
      post :create, verification: { adviser_id: @verification.adviser_id, email: @verification.email, name: @verification.name, phone: @verification.phone, user_id: @verification.user_id }
    end
  ...
  test "should update verification" do
    put :update, id: @verification, verification: { adviser_id: @verification.adviser_id, email: @verification.email, name: @verification.name, phone: @verification.phone, user_id: @verification.user_id }
    assert_redirected_to verification_path(assigns(:verification))
  end
